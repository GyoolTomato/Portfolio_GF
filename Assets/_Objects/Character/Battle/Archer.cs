...
namespace Assets.Character.Battle
{
    ...
    {
        private StateMachine.Base.State m_state;
        private StateMachine.Base.StateMachineBase m_stateMachineBase;
        ...
        {
            base.Awake();
            Initialize(m_dbManager.GetIndexDBController().TDoll(4), 1.5f);
