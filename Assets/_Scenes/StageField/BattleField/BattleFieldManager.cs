...
namespace Assets.Scenes.StageField.BattleField
{
    public class BattleFieldManager
    {
        ...
        {            
            ...
            m_platoonMonitorController.ApplyData(battleData);
        ...
        private IEnumerator CreatePlayer(Player player)
        {
            ...
            var member1 = m_dbManager.GetUserDBController().UserTDoll(platoon.Member1);
            var member2 = m_dbManager.GetUserDBController().UserTDoll(platoon.Member2);
            var member3 = m_dbManager.GetUserDBController().UserTDoll(platoon.Member3);
            var member4 = m_dbManager.GetUserDBController().UserTDoll(platoon.Member4);
