...
namespace Assets.Scenes.Factory.Controller
{
    public class ProduceEquipmentController : Base.ProduceBase
    {
        ...
        {
            if (m_workResourceManager.EquipmentTicket().Amount >= 0)
            {
                m_workResourceManager.OthersResourceAmountCal(Common.WorkResource.WorkResourceManager.E_OthersResourceType.EquipmentTicket, -1);
