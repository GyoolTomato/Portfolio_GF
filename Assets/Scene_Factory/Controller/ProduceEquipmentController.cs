...
namespace Assets.Scene_Factory.Controller
{
    public class ProduceEquipmentController : Base.ProduceBase
    {
        ...
        public override void Initialize(GameManager gameManager, TicketResourceController ticketResourceController, string menuName)
        {
            ...
            {
                item.Initialize(m_gameManager.GetUserDBController().UserProduceEquipment()[produceDBIndex], OrderReceive, Complete);
                produceDBIndex++;
            }
        }
        ...
        {
            if (m_gameManager.GetResourceContorller().EquipmentTicket().Amount >= 0)
            {
                m_gameManager.GetResourceContorller().OthersResourceAmountCal(Common.Controller.ResourceContorller.E_OthersResourceType.EquipmentTicket, -1);
                ...
                if (steel >= 200 &&
                    ...
                    leather >= 100)
                {
                    list = m_gameManager.GetIndexDBController().Equipment(Common.Controller.IndexDBController.E_Equipment.All);
                    ...
                    leather >= 100)
                {
                    list = m_gameManager.GetIndexDBController().Equipment(Common.Controller.IndexDBController.E_Equipment.Weapon);
                    ...
                    leather >= 100)
                {
                    list = m_gameManager.GetIndexDBController().Equipment(Common.Controller.IndexDBController.E_Equipment.Armor);
                    ...
                    leather >= 100)
                {
                    list = m_gameManager.GetIndexDBController().Equipment(Common.Controller.IndexDBController.E_Equipment.Tool);
                ...
                var tempList = m_gameManager.GetIndexDBController().Equipment(Common.Controller.IndexDBController.E_Equipment.All);
                ...
                m_gameManager.GetUserDBController().UpdateProduceEquipment(produceData);
            }
            else
                result = false;
        }
